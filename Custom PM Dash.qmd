...
include-before-body:
  text: |
    <div class="dashboard-header">
      ...
      <span class="header-sub">Performance Measures Dashboard</span>
...
include-in-header:
  text: |
    <style>
      ...
      /* PERFORMANCE METRIC SUMMARY CARD */
...
![](images/Performance_measures_header_main.jpg){width="100%"}
<button onclick="window.print()" class="print-button">
  Print / Save as PDF
</button>

The [Palm Beach Metropolitan Planning Organization (MPO)](https://palmbeachmpo.org/) is the federally designated transportation planning agency for Palm Beach County responsible for developing long-range transportation plans, programming federal transportation funding, and monitoring system performance.
...
scorecard |>
  ...
  # Major scorecard section headings
  tab_style(
    style = cell_text(
      weight = "bold",
      size = px(20),
    ...
    locations = cells_body(
      ...
      rows = Metric %in% c(
        ...
        "SYSTEM PERFORMANCE RELIABILITY",
        "TRANSIT ASSET MANAGEMENT",
        "TRANSIT ASSETS: PALM TRAN",
        "TRANSIT ASSETS: TRI-RAIL",
        "TRANSIT SAFETY: PALM TRAN"
      )
    )
  ) |>

  # Scorecard subsection headings
  tab_style(
    style = cell_text(
      weight = "bold",
      size = px(18),
  ...
  # System Performance hyperlink
  text_transform(
    locations = cells_body(
      columns = Metric,
      rows = Metric == "SYSTEM PERFORMANCE RELIABILITY"
    ),
    fn = function(x) {
      html(
        paste0(
  ...
  text_transform(
    locations = cells_body(
      columns = Metric,
      rows = Metric == "TRANSIT ASSETS: PALM TRAN"
    ),
    fn = function(x) {
      html(
        paste0(
          '<a href="#palm-tran-assets" ',
          'style="color:#646566; ',
          'text-decoration:none; ',
          'font-weight:bold;">',
          x,
  ...
  text_transform(
    locations = cells_body(
      columns = Metric,
      rows = Metric == "TRANSIT ASSETS: TRI-RAIL"
    ),
    fn = function(x) {
      html(
        paste0(
          '<a href="#tri-rail-assets" ',
          'style="color:#646566; ',
          'text-decoration:none; ',
          'font-weight:bold;">',
          x,
    ...
    # Transit Safety: Palm Tran hyperlink
  text_transform(
    locations = cells_body(
      columns = Metric,
      rows = Metric == "TRANSIT SAFETY: PALM TRAN"
    ),
    fn = function(x) {
      html(
        paste0(
          '<a href="#transit-safety" ',
          'style="color:#646566; ',
          'text-decoration:none; ',
          'font-weight:bold;">',
          x,
...
fatalities_summary <- data.frame(
  Metric = "Fatalities (5-YR Avg.)",
  Current = "210",
  Target = "0",
  Status = "Missed Goal ✕"
)
...
fatalities_summary |>
  ...
  text_transform(
    ...
    fn = function(x) {
      html(
        paste0(
          '<div style="font-size:22px;font-weight:700;color:#646566;line-height:1.1;">',
          x,
          '</div>',
          '<div style="font-size:14px;color:#646566;margin-top:2px;line-height:1.1;">',
          'Palm Beach County',
          '</div>'
        )
      )
  ...
  text_transform(
    ...
    fn = function(x) {
      html(
        paste0(
          '<div style="font-size:14px;color:#646566;line-height:1;">Current</div>',
          '<div style="font-size:32px;font-weight:700;color:#147BD1;line-height:1;">',
          x,
          '</div>',
          '<div style="font-size:14px;font-weight:700;color:#646566;line-height:1;">Fatalities</div>',
          '<div style="font-size:12px;color:#646566;line-height:1;margin-top:3px;">2024</div>'
        )
      )
    }
  ) |>
  text_transform(
    ...
    fn = function(x) {
      html(
        paste0(
          '<div style="font-size:14px;color:#646566;line-height:1;">Target</div>',
          '<div style="font-size:32px;font-weight:700;color:#147BD1;line-height:1;">',
          x,
          '</div>',
          '<div style="font-size:14px;font-weight:700;color:#646566;line-height:1;">Fatalities</div>'
  ...
  cols_align(
    align = "center",
    columns = c(Current, Target, Status)
  ) |>
  cols_align(
    align = "left",
    columns = Metric
  ...
  tab_options(
    ...
    table.border.top.color = "#D9E2EC",
    table.border.bottom.color = "#D9E2EC",
    table_body.hlines.color = "white",
    table_body.vlines.color = "#D9E2EC"
  )
```
...
highchart() |>
  ...
  hc_title(
    text = "Roadway Fatalities by Year"
  ) |>
  hc_subtitle(
...
:::{.text-left}
Source: FDOT Source Book (PM1/PM2/PM3).
:::
...
:::
:::
# 2) Infrastructure Conditions {#infrastructure}
## Bridge Conditions
:::{.text-left}
...
<a href="https://performance-data-integration-space-fdot.hub.arcgis.com/pages/mpo-performance-resources"
   target="_blank"
   rel="noopener noreferrer">
FDOT Federal Performance Measures Resources.
</a>

<a href="https://www.fdot.gov/maintenance/divisions.shtm/structures/bridgeinfo.shtm"
   target="_blank"
   rel="noopener noreferrer">
FDOT Bridge Information.
</a>

<a href=" https://performance-data-integration-space-fdot.hub.arcgis.com/pages/performance-reports"
   target="_blank"
   rel="noopener noreferrer">
FDOT Transportation Asset Management Plan.
</a>
:::
...
Source: FDOT Source Book (PM1/PM2/PM3).
:::
# 4) Transit Assets: Palm Tran {#palm-tran-assets}
:::{.text-left}
...
:::
:::
# 5) Transit Assets: Tri-Rail {#tri-rail-assets}
:::{.text-left}
The multi-county regional train service provider, **South Florida Regional Transportation Authority (Tri-Rail)** establishes goals so that most vehicles remain newer than their useful life, and most facilities remain in good condition. The goals below are for Tri-Rail. Palm Tran performance measure goals are shown on a separate page.
:::
::: {.panel-tabset .nav-pills}
...
:::
:::
# 6) Transit Safety: Palm Tran {#transit-safety}
...
fatalities_fbr <- read_excel(
  "C:/MPO/OneDrive - Palm Beach MPO/Documents/Performance_Measures/Performance_Measures_R.xlsx",
  sheet = "Fatalities_FBR"
)
...
highchart() |>
  ...
  hc_title(text = "Fixed Route Bus Fatalities") |>
  hc_subtitle(text = "Palm Tran") |>
  hc_xAxis(
    categories = as.character(fatalities_fbr$Year),
    title = list(text = "Year")
  ) |>
  hc_yAxis(
    title = list(text = "Number of Fatalities"),
  ...
  hc_add_series(
    name = "Fatalities",
    data = fatalities_fbr$Number,
    color = "#147BD1"
  ) |>
  hc_add_series(
    name = "Target",
    data = fatalities_fbr$Target,
    type = "line",
    dashStyle = "Dash",
    color = "#000000",
    marker = list(enabled = FALSE)
...
highchart() |>
  ...
  hc_title(text = "Fixed Route Bus Injuries") |>
  hc_subtitle(text = "Palm Tran") |>
  hc_xAxis(
    categories = as.character(injuries_fbr$Year),
    title = list(text = "Year")
  ) |>
  hc_yAxis(
  ...
  hc_add_series(
    name = "Injuries",
    data = injuries_fbr$Number,
    color = "#147BD1"
  ) |>
  hc_add_series(
    name = "Target",
    data = injuries_fbr$Target,
    type = "line",
    dashStyle = "Dash",
    color = "#000000",
    marker = list(enabled = FALSE)
...
highchart() |>
  ...
  hc_title(text = "Paratransit Fatalities") |>
  hc_subtitle(text = "Palm Tran Connection") |>
  hc_xAxis(
    categories = as.character(fatalities_pt$Year),
    title = list(text = "Year")
  ) |>
  hc_yAxis(
    title = list(text = "Number of Fatalities"),
  ...
  hc_add_series(
    name = "Fatalities",
    data = fatalities_pt$Number,
    color = "#147BD1"
  ) |>
  hc_add_series(
    name = "Target",
    data = fatalities_pt$Target,
    type = "line",
    dashStyle = "Dash",
    color = "#000000",
    marker = list(enabled = FALSE)
...
highchart() |>
  ...
  hc_title(text = "Paratransit Injuries") |>
  hc_subtitle(text = "Palm Tran Connection") |>
  hc_xAxis(
    categories = as.character(injuries_pt$Year),
    title = list(text = "Year")
  ) |>
  hc_yAxis(
    title = list(text = "Number of Injuries"),
  ...
  hc_add_series(
    name = "Injuries",
    data = injuries_pt$Number,
    color = "#147BD1"
  ) |>
  hc_add_series(
    name = "Target",
    data = injuries_pt$Target,
    type = "line",
    dashStyle = "Dash",
    color = "#000000",
    marker = list(enabled = FALSE)
...
:::{.text-left}
Source: Palm Tran Public Transportation Agency Safety Plan. TEST
:::
