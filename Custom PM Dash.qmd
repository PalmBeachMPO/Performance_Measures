...
The following goals, objectives, performance measures and targets are associated with the MPO’s Vision of a safe, efficient, and connected multimodal transportation system. The performance measures and targets are adopted into the TPA's 2050 Long Range Transportation Plan (LRTP) and integrated into the the TPA's 5-Year Transportation Improvement Program (TIP). 
