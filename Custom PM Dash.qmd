...
scorecard |>
  ...
  tab_style(
    style = cell_text(color = "#F8485E", weight = "bold", size = px(23)),
    locations = cells_body(
  ...
  tab_style(
    style = cell_text(color = "#26D07C", weight = "bold", size = px(23)),
    locations = cells_body(
      columns = Goal_Met_Display,
      rows = Goal_Met_Display == "✓"
    )
  ...
  tab_style(
    style = cell_text(color = "#646566", weight = "bold", size = px(17)),
    locations = cells_body(
      columns = Goal_Met_Display,
