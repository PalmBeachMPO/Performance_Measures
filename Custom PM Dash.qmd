...
:::
## Map of Bridges in Poor or Almost Poor Condition
...
bridges <- read_excel(
  "C:/MPO/OneDrive - Palm Beach MPO/Documents/Performance_Measures/data/bidges_DA.xlsx"
)
...
bridges <- bridges |>
  mutate(
    ...
    bubble_size = sqrt(`Deck Width`) / 2
  )

pal <- colorFactor(
  palette = c("#26D07C", "orange", "#F8485E"),
  domain = bridges$Condition
)
...
leaflet(bridges) |>
  ...
  addCircleMarkers(
    ...
    popup = ~paste0(
      "<b>Bridge ID:</b> ", Bridge_ID,
      "<br><b>Condition:</b> ", Condition,
      "<br><b>Deck Width:</b> ", round(`Deck Width`,1), " ft"
    )
  ) |>
    ...
    <div style='background:white;
      ...
      <svg width='140' height='75'>
        ...
        <circle cx='18' cy='55' r='4'
                ...
                fill-opacity='0.5'
                stroke='black'/>
        <text x='35' y='59' font-size='12'>25 ft</text>

        <circle cx='18' cy='38' r='8'
                fill='gray'
                fill-opacity='0.5'
                stroke='black'/>
        <text x='35' y='42' font-size='12'>100 ft</text>

        <circle cx='18' cy='15' r='12'
                fill='gray'
                fill-opacity='0.5'
                stroke='black'/>
        <text x='35' y='19' font-size='12'>200+ ft</text>
